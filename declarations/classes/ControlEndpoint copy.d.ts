...
import { IControlPointRes } from 'spinal-env-viewer-plugin-control-endpoint-service/src/interfaces/IControlPointRes';
export default class ControlEndpointService {
     ...
     * @returns Promise
     */
    linkControlPointToGroup(nodeId: string, controlPointContextId: string, controlPointId: string, linkDirectlyToGroup?: boolean): Promise<Array<SpinalNodeRef>>;
    /**
    ...
    _LinkNode(groupId: string, controlPointContextId: string, controlPointId: string, controlPoints: {
        name: string;
        endpoints: spinal.Lst<IControlEndpointModel>;
    }, linkDirectlyToGroup: boolean): Promise<SpinalNodeRef[]>;
    removeItemFromLst(lst: spinal.Lst<SpinalNode<any>> | spinal.Lst<ILinkedToGroupRes>, itemId: string): boolean;
}

...
import { IControlEndpoint, ILinkedToGroupRes } from '../interfaces/ControlEndpoint';
...
export default abstract class Utilities {
    ...
    static isLinked(items: spinal.Lst<SpinalNode> | spinal.Lst<ILinkedToGroupRes>, id: string): boolean;
